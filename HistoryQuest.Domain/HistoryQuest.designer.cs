...
namespace HistoryQuest.Domain
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="HistoryQuest")]
    ...
    partial void DeleteUsersInRole(UsersInRole instance);
		...
		public HistoryQuestDataContext() : 
				base(global::HistoryQuest.Domain.Properties.Settings.Default.HistoryQuestConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnIsTeacherChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Face_Face", Storage="_Faces", ThisKey="gid", OtherKey="TeacherGID")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Face_Face", Storage="_Face1", ThisKey="TeacherGID", OtherKey="gid", IsForeignKey=true)]
		public Face Face1
		{
			get
			{
			...
			set
			{
							...
							|| (this._Face1.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._TeacherGID = default(Nullable<System.Guid>);
					}
	...
	public partial class PupilsToTeachersRequest : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Guid _PupilsGID;
    ...
    partial void OngidChanging(System.Guid value);
    partial void OngidChanged();
    partial void OnPupilsGIDChanging(System.Guid value);
    partial void OnPupilsGIDChanged();
		...
		public System.Guid PupilsGID
		{
			...
			set
			{
				if ((this._PupilsGID != value))
				{
					...
					this.SendPropertyChanged("PupilsGID");
					this.OnPupilsGIDChanged();
				}
			}
		}
